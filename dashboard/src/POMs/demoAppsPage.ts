...
export function buildDemoAppsPageObject(page: Page) {
  return {
    page,
    actions: {
      switchToTab: async () => {
...
export const buildDemoAppsPage = buildDemoAppsPageObject satisfies PomFactory

export type DemoAppsPageObject = ReturnType<typeof buildDemoAppsPage>
